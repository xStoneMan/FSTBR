...
import com.fstbr.demo.Config.Constant;
import com.fstbr.demo.Domain.TemplateDO.ColumnDO;
import com.fstbr.demo.Domain.TemplateDO.TableDO;
import com.fstbr.demo.Exception.BDException;
...
public class GenUtils {
    ...
    public static void generatorCode(Map<String, String> table,
        ...
        for (String template : templates) {
            ...
            try {
                // 生成对应文件
                String path = getFileName(template, tableDO.getClassname(), tableDO.getClassName(), config.getString("package"));
...
//            }
    ...
    public static String getFileName(String template, String classname, String className, String packageName) {
        ...
        if (template.contains("Service.java.vm")) {
            return packagePath + "Service" + File.separator + "Service" + File.separator + className + "Service.java";
        }

        if (template.contains("ServiceImpl.java.vm")) {
            return packagePath + "Service" + File.separator + "Implement" + File.separator + className + "ServiceImpl.java";
        }
        ...
        if (template.contains("Mapper.xml.vm")) {
            return "src" + File.separator + "main" + File.separator + "resources" + File.separator + "mappers" + File.separator + className + "Mapper.xml";
        }

        if (template.contains("list.html.vm")) {
            return "src" + File.separator + "main" + File.separator + "resources" + File.separator + "templates" + File.separator
                + "templates" + File.separator + packageName + File.separator + classname + File.separator + classname + ".html";
            //				+ "modules" + File.separator + "generator" + File.separator + className.toLowerCase() + ".html";
        }
        if (template.contains("add.html.vm")) {
            return "src" + File.separator + "main" + File.separator + "resources" + File.separator + "templates" + File.separator + "templates" + File.separator + classname + File.separator + "add.html";
        }
        if (template.contains("edit.html.vm")) {
            return "main" + File.separator + "resources" + File.separator + "templates" + File.separator + "templates" + File.separator + classname + File.separator + "edit.html";
        }
